...
class GameInterface(Frame):
        ...
        for row in range(4):
            for col in range(4):
                ...
                if cell_value == 0:
                    ...
                    print("Debug 2 cell b4: ")
                    print(self.cells[row][col]["number"])
    ...
    def show_score(self):
        ...
        score_l = Label(master=score_f, text="peppa: " + str(self.score), justify=CENTER,font=colors.SCORE_LABEL_FONT)
